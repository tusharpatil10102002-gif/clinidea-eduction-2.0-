  ...
  return (
    <div className="modern-course-grid">
      <div className="sleek-card" onClick={() => window.location.href = '/clinical-research-pharmacovigilance-course'}>
        <div className="sleek-card-img" style={{ backgroundImage: `url('/Courses Images/Clinical Research & Pharmacovigilance.jpg')` }}></div>
      ...
      <div className="sleek-card" onClick={() => window.location.href = '/clinical-research-data-management-course'}>
        <div className="sleek-card-img" style={{ backgroundImage: `url('/Courses Images/Clinical Research & Data Management.avif')` }}></div>
        <div className="sleek-card-body">
      ...
      <div className="sleek-card" onClick={() => window.location.href = '/clinical-research-cr-pv-dm-course'}>
        <div className="sleek-card-img" style={{ backgroundImage: `url('/Courses Images/Clinical Research, Pharmacovigilance & Data Management.jpg')` }}></div>
        <div className="sleek-card-body">
      ...
      <div className="sleek-card" onClick={() => window.location.href = '/clinical-research-regulatory-affairs-course'}>
        <div className="sleek-card-img" style={{ backgroundImage: `url('/Courses Images/Clinical Research & Regulatory Affairs.jpg')` }}></div>
        <div className="sleek-card-body">
      ...
      <div className="sleek-card" onClick={() => window.location.href = '/clinical-research-medical-writing-course'}>
        <div className="sleek-card-img" style={{ backgroundImage: `url('/Courses Images/Clinical Research & Medical Writing.jpg')` }}></div>
        <div className="sleek-card-body">
      ...
      <div className="sleek-card" onClick={() => window.location.href = '/clinical-research-medical-coding-course'}>
        <div className="sleek-card-img" style={{ backgroundImage: `url('/Courses Images/Clinical Research and Medical Coding.jpg')` }}></div>
        <div className="sleek-card-body">
